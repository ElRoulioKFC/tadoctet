const initialState = {idPartie: -1, idJoueur: -1, helmet : ['',0,0,0,0], armor: ['',0,0,0,0],weapon:['',0,0,0,0],weaponRange:['',0,0,0,0], bag: ['',0], heal: ['',0],pv : 30, end: 3,for : 3, agi : 3,per:3, ferrailleJoueur: 0, boisJoueur: 0, alcoolJoueur: 0, medicamentJoueur: 0, textileJoueur: 0,feraille: 0,bois: 0, medicament: 0, textile: 0, alcool: 0,texteAventure: '',listeBoutonAventure:[]}
  ...
  switch (action.type) {
    ...
    case 'updateEquipment':
      nextState = {
        ...
        bag: [action.value.nameHeal,action.value.slotValue]
      }
      return nextState
    ...
    case 'updateEvent':
          nextState = {
            ...state,
            texteAventure: action.value.texteAventure,
            listeBoutonAventure: action.value.listeBoutonAventure
          }
        return nextState
    default :
      return state
